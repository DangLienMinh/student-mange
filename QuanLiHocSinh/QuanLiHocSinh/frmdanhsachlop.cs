...
namespace QuanLiHocSinh
{
    public partial class frmDanhSachLop :DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private void applicationButton1_Click_1(object sender, EventArgs e)
        {
        ...
        private void ribbonTabItem2_Click_1(object sender, EventArgs e)
        {

        }

        private void tabquanlyhoso_Click(object sender, EventArgs e)
        {
        ...
        private void tabbaocaotonghop_Click(object sender, EventArgs e)
        {
        ...
        private void sideBar2_Click(object sender, EventArgs e)
        {

        }

        private void grpthongtinhocsinh_Click(object sender, EventArgs e)
        {
